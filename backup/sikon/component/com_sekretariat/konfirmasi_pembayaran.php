...
echo "<form method=POST action=$_SERVER[PHP_SELF]?component=sekretariat&act=konfirmasi_pembayaran>
		...
		echo "<div id='div01'>
			...
			if ($r[status] == "Pendaftar") {
				...
				echo "<form method=POST action=component/com_sekretariat/proses.php?act=konfirmasi_pembayaran
					...
					<input type='hidden' name='no_registrasi' value='$r[no_registrasi]' />
