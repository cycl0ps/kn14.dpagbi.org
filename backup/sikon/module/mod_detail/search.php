...
$sql2		= mysql_query("SELECT tanggal_bayar FROM pembayaran WHERE no_peserta = '$r[no_peserta]'");
...
echo "
<div class='contentHeading'>Detail Peserta</div>
<div id='div04'>
<p><span class='emp1'>No. Registrasi : #$r[no_registrasi]</span></p>
<p><span class='emp1'>Tanggal Daftar : $regdate</span></p>
<p><span class='emp1'>Kategori : $r[status]</span></p>";

if ($r[status]=='Pendaftar') {
	echo "<p><span class='emp1'>Status Bayar : Belum Bayar/Konfirmasi Pembayaran</span></p>";
} else {
	echo "<p><span class='emp1'>No. Peserta : $r[no_peserta]</span></p>
		<p><span class='emp1'>Status Bayar : Sudah Bayar/Konfirmasi Pembayaran</span></p>
