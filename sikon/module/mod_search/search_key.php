...
if (empty($key)){
	...
	if ($jumlah > 0) {
		...
		while ($r=mysql_fetch_array($sql)){
			echo "<tr>
					<td valign='top'>$i.</td>
					<td valign='top'><a href=$_SERVER[PHP_SELF]?module=detail&act=biodata&id=$r[no_registrasi]>";
					echo (stripslashes($r[nama_lengkap]));echo "</a></td>
					<td>
		...
		echo "<p>Tidak ditemukan data dengan kata kunci: <span class='emp1'>$key</span></p>";
	}
}
?>